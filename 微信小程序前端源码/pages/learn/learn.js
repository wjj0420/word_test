...
Page({
  ...
  adddata(){
   ...
   getdata(){
    console.log("yes1")
    console.log("getdata的this",this)
    let that=this
    db.collection('words')
    .get({
      success: function(res) {
        //console.log(res.data)
        //console.log("success的this",this)
       // console.log("success的that",that)
        that.setData({
          dataobj:res.data
  ...
  changeText: function () {
    //console.log("this is index",this.data.num)
   // console.log("this is ",this.data)
    // this.data.text = 'changed data'  // bad,console.log("this is ",this.data.index) it can not work
    this.setData({
